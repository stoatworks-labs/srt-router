...
**[v0.2.1](https://github.com/stoatworks-labs/srt-router/releases/tag/v0.2.1)** — prebuilt for macOS, Windows and Linux. Pick your platform:
...
| Build | Download | Size |
| --- | --- | --- |
| Apple Silicon · .dmg disk image (app) | [`srt-router-0.2.1-macos-aarch64-app.dmg`](https://github.com/stoatworks-labs/srt-router/releases/download/v0.2.1/srt-router-0.2.1-macos-aarch64-app.dmg) | 10 MB |
| Apple Silicon · .dmg disk image (CLI) | [`srt-router-0.2.1-macos-aarch64-cli.dmg`](https://github.com/stoatworks-labs/srt-router/releases/download/v0.2.1/srt-router-0.2.1-macos-aarch64-cli.dmg) | 8.3 MB |
| Intel · .dmg disk image (app) | [`srt-router-0.2.1-macos-x86_64-app.dmg`](https://github.com/stoatworks-labs/srt-router/releases/download/v0.2.1/srt-router-0.2.1-macos-x86_64-app.dmg) | 10 MB |
| Intel · .dmg disk image (CLI) | [`srt-router-0.2.1-macos-x86_64-cli.dmg`](https://github.com/stoatworks-labs/srt-router/releases/download/v0.2.1/srt-router-0.2.1-macos-x86_64-cli.dmg) | 8.5 MB |
| Apple Silicon · .pkg installer (app) | [`srt-router-0.2.1-macos-aarch64-app.pkg`](https://github.com/stoatworks-labs/srt-router/releases/download/v0.2.1/srt-router-0.2.1-macos-aarch64-app.pkg) | 10 MB |
| Apple Silicon · .pkg installer (CLI) | [`srt-router-0.2.1-macos-aarch64-cli.pkg`](https://github.com/stoatworks-labs/srt-router/releases/download/v0.2.1/srt-router-0.2.1-macos-aarch64-cli.pkg) | 7.1 MB |
| Intel · .pkg installer (app) | [`srt-router-0.2.1-macos-x86_64-app.pkg`](https://github.com/stoatworks-labs/srt-router/releases/download/v0.2.1/srt-router-0.2.1-macos-x86_64-app.pkg) | 11 MB |
| Intel · .pkg installer (CLI) | [`srt-router-0.2.1-macos-x86_64-cli.pkg`](https://github.com/stoatworks-labs/srt-router/releases/download/v0.2.1/srt-router-0.2.1-macos-x86_64-cli.pkg) | 7.3 MB |
...
| Build | Download | Size |
| --- | --- | --- |
| x64 · .exe installer | [`srt-router-0.2.1-windows-x86_64-setup.exe`](https://github.com/stoatworks-labs/srt-router/releases/download/v0.2.1/srt-router-0.2.1-windows-x86_64-setup.exe) | 1.7 MB |
| ARM64 · .exe installer | [`srt-router-0.2.1-windows-aarch64-setup.exe`](https://github.com/stoatworks-labs/srt-router/releases/download/v0.2.1/srt-router-0.2.1-windows-aarch64-setup.exe) | 1.5 MB |
...
| Build | Download | Size |
| --- | --- | --- |
| x64 · .deb package (Debian/Ubuntu) | [`srt-router_0.2.1_amd64.deb`](https://github.com/stoatworks-labs/srt-router/releases/download/v0.2.1/srt-router_0.2.1_amd64.deb) | 2.8 MB |
| ARM64 · .deb package (Debian/Ubuntu) | [`srt-router_0.2.1_arm64.deb`](https://github.com/stoatworks-labs/srt-router/releases/download/v0.2.1/srt-router_0.2.1_arm64.deb) | 2.9 MB |
| x64 · .rpm package (Fedora/RHEL) | [`srt-router-0.2.1-1.x86_64.rpm`](https://github.com/stoatworks-labs/srt-router/releases/download/v0.2.1/srt-router-0.2.1-1.x86_64.rpm) | 2.9 MB |
| ARM64 · .rpm package (Fedora/RHEL) | [`srt-router-0.2.1-1.aarch64.rpm`](https://github.com/stoatworks-labs/srt-router/releases/download/v0.2.1/srt-router-0.2.1-1.aarch64.rpm) | 3.0 MB |
